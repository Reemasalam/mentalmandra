...
class DepressionScreen extends StatefulWidget {
  @override
  _DepressionScreenState createState() => _DepressionScreenState();
}
...
class _DepressionScreenState extends State<DepressionScreen> {
  ...
  void initState() {
    super.initState();
    _controller1 = VideoPlayerController.asset('assets/yoga_for_depression.mp4');
    _controller2 = VideoPlayerController.asset('assets/yoga_for_depression2.mp4');
    _controller3 = VideoPlayerController.asset('assets/yoga_for_depression3.mp4');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Yoga for Depression Relief'),
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            SizedBox(height: 20),
            buildCard(_controller2, _initializeVideoPlayerFuture2, 'Child pose'),
            SizedBox(height: 20),
            buildCard(_controller3, _initializeVideoPlayerFuture3, 'Sun Salutation'),
          ],
        ),
      ),
    );
